        ...
        <div style={aboutStyle}>
          <div className="aboutStyleGrid">
            <div className="aboutStyleGridText">
              ...
              <br></br>
              <p>
                AAGAZ'23 is the descendant of the program initiated by Sports
                Sub-Council. The event aims to bring all the sports events under
                the auspices of a Mega Inter-College sports fest!!
                <br></br>
                <br />
                AAGAZ'23 will be a new & better version of AAGAZ'22 which was a
